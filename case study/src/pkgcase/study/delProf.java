 ...
 */
public class delProf extends javax.swing.JFrame {

    /**
     * Creates new form delProf
     */
    public delProf() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Delete Professor");
    ...
    private void backActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backActionPerformed
        Professor p = new Professor();       //student button
        p.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_backActionPerformed

    private void delActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_delActionPerformed
        TEJUCO.P_deleteRecord("Professors.txt",this.idNo.getText());
        idNo.setText(null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delProf.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
