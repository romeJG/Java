...
public class updateBook extends javax.swing.JFrame {
    ...
    private static void update(String f) {
        ...
        try {
            ...
            pw.println(an.getText() + "," + bn.getText() + "," + txtName.getText() + "," + txtAuth.getText() + "," + txtCat.getText() + "," + ave.getText());
            scan.close();
            pw.flush();
            pw.close();
            bw.close();
    ...
    private void initComponents() {
        ...
        upd.setBackground(new java.awt.Color(102, 255, 102));
        upd.setText("Update");
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(28, 28, 28)
                                .addComponent(upd, javax.swing.GroupLayout.PREFERRED_SIZE, 101, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel1Layout.createSequentialGroup()
