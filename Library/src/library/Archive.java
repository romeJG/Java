...
public static Scanner scan;
    ...
    private static void update(String f) {
        ...
        try {
            ...
            pw.println(an.getText() + "," + bn.getText() + "," + txtName.getText() + "," + txtAuth.getText() + "," + txtCat.getText() + "," + "Archived");
            ...
            JOptionPane.showMessageDialog(null, "error Not Archived" +e);
        }
